...
\begin{table}[htbp]
    ...
    \begin{minipage}[t]{0.31625\linewidth}
        ...
        \begin{tabular}{ccc}
            ...
            \bottomrule
        \end{tabular}}
        % anderes verständnis der rubrik wohl + zwischenwerte..
    \end{minipage}
\end{table}
\end{frame}
...
\begin{frame}[allowframebreaks]{Hauptergebnisse zu RQ1}
    \begin{itemize}
        ...
        % adherence score zeigte recht deutlich, dass die Fragen inhaltlich gut waren
        % sentence transformer aber ungeeignet für lange Texte
        \item \textbf{Common Prompt > Complex} meistens
        % sowohl bei quantitativ als auch qualitativ
        % qualitativ: Complex nur besser in Challenging mit Qualitätseinbußen
        ...
        % Transcript an sich bestes in Clarity/Answerability/Correctness, aber am niedrigsten in Challenging
        % Script ausgewogen mit höchstem Total Score, Script bei Staff das effektivere Material
        \item OpenAI \& DeepSeek \textbf{konsistenter}
        % Anthropic \& Google variabler + teils sprachlich komplex oder mit fehlerhaften\,/\,erfundenen Optionen
        % Challenging generell niedrig
        ...
        % Anthropic \& Google folgen hierbei häufiger
        \item \textbf{Kleine Stichprobe} (16/56) und \textbf{geringe IRR} \\
        % deswegen auch google und anthropic da besser stattdessen
        $\Rightarrow$ Inkonsistente Trends quantitativ \& qualitativ
        % da trend invers bei qualitativ
...
\begin{frame}[allowframebreaks]{Hauptergebnisse zu RQ2}
    \begin{itemize}
        ...
        % es braucht besseres rubrik-design (vor allem wegen value) + anker muessen klarer sein
