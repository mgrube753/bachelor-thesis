...
\begin{frame}[allowframebreaks]{Hauptergebnisse zu RQ1}
    \begin{itemize}
        \item \textbf{LLMs erzeugen inhaltstreue Fragen} unter bestimmten Bedingungen
        ...
        % impliziert dass ein überladener/weniger präziser Prompt nicht unbedingt besser sein muss
        ...
        \item Bloom's Taxonomy relevant für gute + anforderungsgesteuerte Fragen
    \end{itemize}
...
\begin{frame}[allowframebreaks]{Hauptergebnisse zu RQ2}
    \begin{itemize}
        ...
        % $\Rightarrow$ OpenAI \textbf{Level-6 MCQ}-Widerspruch
        \item Hohe IRR bei \textit{Bloom's Level}, andere Kriterien niedrig
...
\begin{frame}[allowframebreaks]{Limitations\,/\,Future Work}
    \begin{itemize}
        ...
        % kein unterschied in inhaltstreue zwischen fragen mit source material und ohne...
