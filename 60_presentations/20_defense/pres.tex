...
\begin{frame}{Motivation \& Problemstellung II}
    \begin{itemize}
        \item \textbf{Problemstellung:} Qualität oft unklar $\to$ mangelnde systematische Evaluation über linguistische Tests hinaus \cite{horbach_linguistic_2020} 
            ...
            \note[item]{P1: da auch die \textbf{pädagogische Eignung} bewertet werden muss über \textbf{Experten}, was bis dato selten gemacht wurde \\}
        \begin{itemize}
            ...
            \item Mangelnde Performance bei höheren kognitiven Levels \cite{elkins_how_2023,scaria_how_2024}
                \note[item]{P1.2: die genutzten Modelle sind auch \textbf{nicht die neuesten}. \\}
            ...
            \item Relevanz $\neq$ Inhaltstreue \cite{elkins_how_2023,hang_mcqgen_2024,mi_comparative_2024}
                \note[item]{P1.3: \textbf{Korrektheit} von Fragen \textbf{elementar} in Bildung; von Interesse ist, wie man \textbf{gut} dies in Form von \textbf{Inhaltstreue} umsetzen kann; oft nur als \textbf{Future Work}}
        \end{itemize}
        \vspace{.5em}
...
\begin{frame}{Herausforderungen der Literatur}
    \begin{itemize}
        \item \textbf{Veraltete Modelle} -- Kein Reasoning
            \note[item]{P1: \textbf{Reasoning} basiert auf User Prompt, damit Modell \textbf{brainstormt}, was der User will; wurde in Literatur noch \textbf{nicht genutzt}, sondern \textbf{outdated} Models wie GPT-4/LLaMA2}
        \item \textbf{Halluzinationen} -- Falsche Ausgaben
            \note[item]{P2: Kann man minimieren durch \textbf{Kontext}; Reasoning $\Rightarrow$ Modell kann \textbf{Thema \& Anforderungen hinterfragen}}
        \item \textbf{Inhaltstreue} -- Forschung nötig
            \note[item]{P3: Inhaltstreue eher \textbf{Nebensache}, mehr \textbf{Bloom} Fokus, \textbf{linguistische} Metriken; \textbf{Mangel} an Systemen, welche die Inhaltstreue von LLMs evaluieren}
        \item \textbf{Metriken im Fokus} -- Quantitative Evaluation
            \note[item]{P4: Problematisch, da grundlegend \textbf{linguistisch} \\ \textbf{Expertenbewertung} notwendig bei AQG}
        ...
        \item \textbf{Bloom's Taxonomy} -- Level Alignment \& \\ hohe kognitive Levels
            \note[item]{P6: Schwerste level \textbf{misslingen} in RW; auch \textbf{nicht immer Bloom} benutzt, und wenn, dann eher schlecht \\ $\Rightarrow$ Mit \textbf{neumodischen} Modellen nicht evaluiert}
    \end{itemize}
\end{frame}
...
\begin{frame}{Hauptergebnisse zu RQ1 II}
    ...
    \end{itemize}
        ...
        \note[item]{DeepSeek \& OpenAI dabei am robustesten gewesen}
...
\begin{frame}{Hauptergebnisse zu RQ2 II}
    \begin{itemize}
        ...
        \item Hohe IRR bei \textit{Bloom's Level}
            ...
            \note[item]{Studenten machen Evaluation auch \textbf{nicht jeden Tag}}
