...
\input{../10_extra/abbreviations.tex}
...
\begin{appendices}
  ...
  \counterwithin{listing}{section}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1a/019_tanenbaum_3.txt}{Experiment 1a: Supervisor-rated positive Example}{lst:1a-supervisor-good-example}
    ...
    % openai common prompt 1a transcript
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1a/045_transcript_1.txt}{Experiment 1a: Staff- \& Supervisor-rated positive Example}{lst:1a-staff-supervisor-good-example}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1a/035_transcript_1.txt}{Experiment 1a: Supervisor-rated negative Example (NaN Values)}{lst:1a-supervisor-bad-nan-example}
    ...
    % google common prompt 1a script
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1a/025_script_2.txt}{Experiment 1a: Staff-rated negative Example}{lst:1a-staff-bad-example}
    ...
    % google complex script manipulated 1b
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1b/012_script_manipulated_5.txt}{Experiment 1b: Supervisor- \& Staff-rated positive Example}{lst:1b-supervisor-good-example}
    This complex prompt question by Google demonstrates -- with a lack in linguistic quality -- distancing from the manipulated script by contrasting the manipulated script with the \enquote{traditional} OSI architecture.
    \vp

    % openai common prompt 1b
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1b/013_script_manipulated_2.txt}{Experiment 1b: Supervisor-rated negative Example}{lst:1b-supervisor-bad-example}
    ...
    % 1b openai complex
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp1b/016_script_manipulated_6.txt}{Experiment 1b: Supervisor-rated NaN Example}{lst:1b-supervisor-nan-example}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2a/013_script_all.txt}{Experiment 2a: Student-rated positive Example}{lst:2a-student-good-example}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2a/015_script_all.txt}{Experiment 2a: Student-rated negative Example}{lst:2a-student-bad-example}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2b/002_script_all.txt}{Experiment 2b: Student-rated positive Example}{lst:2b-student-good-example}
    ...
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2b/006_script_all.txt}{Experiment 2b: Student-rated negative Example}{lst:2b-student-bad-example}
    ...
    % exp2c frage 10 als good example
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2c/010_script_all.txt}{Experiment 2c: Student-rated positive Example}{lst:2c-student-good-example}
    ...
    % exp2c frage 4 als bad example
    \longlistingfromfile{markdown}{../../../20_experiments/80_samples_renamed/exp2c/004_script_all.txt}{Experiment 2c: Student-rated negative Example}{lst:2c-student-bad-example}
