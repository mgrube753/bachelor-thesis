...
\begin{appendices}
  ...
  \counterwithin{listing}{section}
    ...
    Anthropic's open-ended question -- Bloom level 4 -- shows a bad example, since it contains too many foreign words and a complex wording, which complicates the meaning of the core task.
