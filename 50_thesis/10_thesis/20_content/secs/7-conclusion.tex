...
% trying content adherence didnt went as expected, but still a good first step.
...
% qualitative analysis (instead of relying on metrics) was a bit hard, since ratings were different, bad agreement because of rating between the given values, ...
