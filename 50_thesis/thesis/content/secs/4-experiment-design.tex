...
\vspace{-1em}
% #todo mehr details zur grafik einbinden (reasoning)
...
\begin{itemize}
    ...
    \begin{itemize}
        % #todo here add o3 and 3.7 sonnet as llm-based evaluators instead
