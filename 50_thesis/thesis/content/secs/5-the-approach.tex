...
% #todo bessere promptbeschreibung geben
...
% #todo handle content fidelity and error propagation? welches ziel? wie umgesetzt, nicht ganz klar.
...
% #todo add sampling (2 questions out of every directory) for llm-based and expert-based evaluation
