...
% \begin{itemize}
%     \item Semantic Similarity, such as BERTScore or own calculation of cosine similarity score
%     \item Quality by more recent metrics like BLEURT (\url{https://github.com/google-research/bleurt}) instead of common linguistic metrics such as BLEU, ROUGE, and METEOR
%     \item LLM-based Perplexity score calculation?
% \end{itemize}
