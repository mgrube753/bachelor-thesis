...
% 1. Doughty et al. (2024) - "A Comparative Study of AI-Generated 
% (GPT-4) and Human-crafted MCQs in Programming Education". DOI: 
% https://
% doi.org/10.1145/3636243.3636256
%      - Probleme dargelegt: Manuelle Multiple-Choice Fragengenerierung 
% ist mit hohem Aufwand verbunden; LLMs wurden für Programmier-MCQs 
% nicht umfassend erforscht; dazu ist die Evaluation bei MCQ-Systemen 
% begrenzt
%      - Wie angegangen: Analyse von GPT-4 bei MCQ-Generierung + 
% Alignment mit spezifischen Lernzielen; vielerlei Infos wurden GPT-4 
% mitgegeben, e.g. Bloom-Definitionen
%      - Limitations: Ansatz mit unplausiblen oder falschen Distraktoren 
% (die falschen Antwortmöglichkeiten) verbunden; Schwierigkeit der MCQs 
% wurde nicht mit Mensch-generierten Fragen verglichen; 
% !!Übereinstimmung der MCQs mit Lerninhalt wurde nicht berücksichtigt; 
% keine Parameter des Modells angepasst sowie auch keine Verfeinerung 
% der Fragen durch Feedbackgabe des Nutzers

% 2. Al Faraby et al. (2024) - "Analysis of LLMs for educational 
% question classification and generation". DOI: https://doi.org/10.1016/
% j.caeai.2024.100298
%      - Probleme dargelegt: Qualität und pädagogische Effektivität von 
% generierten Fragen durch Nutzung von Frameworks wie Bloom's Taxonomie 
% wurden nicht gründlich evaluiert; LLM-basierte Fragengenerierung, bei 
% deer educational Objectives eingehalten werden sollen, sind 
% unerforscht
%      - Wie angegangen: Bildungsfragen klassifizieren, Bewertung LLM- 
% basierter Fragengenerierung, sowie Vergleich von LLM-Fragen und Fragen 
% von menschlichen Experten
%      - Limitations: !!Halluzination ist ein bestehendes Problem, man 
% sollte sich in Zukunft auf den Abgleich der Fragen bzgl. des 
% Eingabetextes fokussieren!!; Geringe Anzahl an Annotatoren; breitere 
% Range von LLMs wären besser

% 3. Blobstein et al. (2023) - "Angel: A New Generation Tool for 
% Learning Material based Questions and Answers". URL: 
% https://gaied.org/ neurips2023/files/9/9_paper.pdf
%      - Probleme dargelegt: Traditionelle Auto-Fragen-Generierungs- 
% Methoden können keine Fragen auf kognitiv hohen Niveaus generieren, 
% schwere Kontrollierbarkeit von Komplexität und Schwierigkeit der 
% Fragen; frühere Arbeiten fokussierte das Einbeziehen von 
% vorformulierten Antworten bei der Fragengenerierung
%      - Wie angegangen: ChatGPT-3.5, um Fragen und Antworten basierend 
% auf Lernmaterial zu generieren; Qualitätsauswertung auch via GPT-3.5 + 
% menschliche Evaluation bei pädagogischer Güte/Bloom Niveau
%      - Limitations: !!Selbst mit diesem Ansatz hat der Evaluator fast 
% alle Fragen als "Remembering" eingestuft; weitere Arbeit und 
% menschliche Evaluation sind nötig, um das Ergebnis genauer zu analysieren!!

% 4. Maity et al. (2025) - "Can large language models meet the challenge 
% of generating school-level questions?". DOI: https://doi.org/10.1016/
% j.caeai.2025.100370
%      - Probleme dargelegt: Erstellen eigener Fragen ist zeitaufwendig 
% und mühsam; !!systematisches Auswerten von generierten Fragen durch 
% Einbeziehen von Frameworks wie Bloom ist oft nicht in prior Work 
% integriert!!, oder haben keine umfassenden Methoden einbezogen, um 
% Vollständigkeit und Relevanz der Fragen zu ermitteln
%      - Wie angegangen: Diverse LLMs wie GPT-3.5/4 etc. mittels 
% Zero-Shot und Few-Shot Prompting (+ Schulbüchern) angesteuert, um eine 
% vollständige Fragemenge zu generieren (welche mit Bloom einhergehen); 
% 8- shot war laut der human Evaluators dabei besser in Quality und 
% Bloom Adherence (da ich keine Beispielfragen für das Modell habe, bin 
% ich ein Konkurrent mit Zero-Shot Prompting) + Leistungsvergleich ggü. 
% humaner Fragen
%      - Limitations: (Ich finde: Nur menschliche Auswertung --> 
% subjektive Auswirkung möglich), sonst wurde nur gesagt, dass man 16- 
% und 32-Shot Prompting ausprobieren möchte

% 5. Scaria et al. (2024) - "How Good are Modern LLMs in Generating 
% Relevant and High-Quality Questions at Different Bloom`s Skill Levels 
% for Indian High School Social Science Curriculum?". URL: https:// 
% aclanthology.org/2024.bea-1.1/
%      - Probleme dargelegt: Kreieren von pädagogisch effektiven Fragen, 
% vor allem bei hohen Skill Levels, ist herausfordernd und 
% zeitaufwendig; Experten-basierte Auswertung ist von Nöten, um 
% pädagogische Aspekte bei Maschinen-generierten Fragen zu verstehen (da 
% automatisierte Metriken eher die linguistischen Aspekte analysieren)
%      - Wie angegangen: Diverse LLMs angesteuert mit Zero-Shot 
% Prompting, um relevante, hochqualitative Fragen zu generieren (über 
% alle Bloom- Ebenen); dabei kam bei den Experten heraus, dass 91% 
% hochqualitativ/ relevant sind; Modell-basierte Unterschiede in 
% Bloom-Adherence
%      - Limitations: Der gleiche Prompt wird immer genutzt, kein Few- 
% Shot, somit keine Diversität in Prompts; Bias in menschlicher 
% Auswertung möglich; !!Automatisierte Annotation wäre hierbei 
% hilfreich, damit man Zeit und Aufwand sparen kann!!
\begin{itemize}
