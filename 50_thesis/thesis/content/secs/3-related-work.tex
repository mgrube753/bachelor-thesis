...
\begin{itemize}
    ...
    % Gaps: limited ability to generate questions targeting high cognitive levels, control over question difficulty, create adequate QA pairs
    ...
    % todo
    % Gaps: creating pedagogically effective questions, especially at higher skill levels, is challenging and time-consuming;
    ...
    % todo
    % Gaps: aqg is time-consuming; critial gap --> systematic assessment of the generated questions using frameworks e.g. bloom; and completeness + relevance are gaps
    ...
    % Gaps: quality and pedagogical effectiveness of llm-generated questions were not thoroughly evaluated, primarily regarding alignment with educational objectives and stimulating critical thinking; hallucinations in llm-generated questions
