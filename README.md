...
- **requirements.txt** – Python dependencies, generated by `pip freeze > requirements.txt` – [`requirements.txt`](requirements.txt)
- **PYTHON_LICENSES.md** – Dependency license summary, generated by `pip-licenses --format=markdown > PYTHON_LICENSES.md` – [`PYTHON_LICENSES.md`](PYTHON_LICENSES.md)
...
- **Quantitative Analysis**: Automated metrics are calculated in [`20_experiments/50_src/analysis_quantitative.py`](20_experiments/50_src/analysis_quantitative.py)
- **Qualitative Analysis**: Expert and student-ratings are stored in [`20_experiments/60_analyses/`](20_experiments/60_analyses/)
- **Evaluation Notebooks**: Jupyter notebooks for evaluations:
  ...
  - [`evaluation1_qual.ipynb`](20_experiments/50_src/evaluation1_qual.ipynb) - Qualitative analysis of Experiment 1
  - [`evaluation2_qual.ipynb`](20_experiments/50_src/evaluation2_qual.ipynb) - Qualitative analysis of Experiment 2
- **Evaluation Results**: Tables & plots in [`40_evaluation/`](40_evaluation/)
...
Beamer slides for (intermediate) defense are in [`60_presentations/`](60_presentations/), including the PDF file for each presentation. Build if needed with:
